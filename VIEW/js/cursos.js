...
function deleta(id) {
    ...
    data.append('id', id); //$_POST['id']
    fetch("http://localhost/TCC/cursos/dell/", {
        method: 'POST',
        body: data
    }).then(function () {
        location.reload();
