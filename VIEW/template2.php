    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" href="http://localhost/TCC/user/admin"><i class="bi bi-people-fill"></i> Usuários</a></li>
            </ul>
          </li>
        </ul>
        ...
        <div class=" form-check form-switch">
          ...
          <div id="themeColor"><i id="sun" class="bi bi-brightness-low-fill"></i><i id="moon" class="bi bi-moon-stars-fill"></i></div>
        </div>
    ...
    <div class="col-3 bar px-5 py-1 dashboard d-none d-lg-block">
      <a href="http://localhost/TCC/home/dashboard" class="btn w-100"><i class="bi bi-speedometer"></i> Dashboard</button>
        ...
        <a class="btn w-100" href="http://localhost/TCC/instituicoes/"><i class="bi bi-building"></i> Instituições</button>
          <a class="btn w-100" href="http://localhost/TCC/user/"><i class="bi bi-people-fill"></i> Usuários</a>
    </div>
