...
<head>
    ...
    <link href="../VIEW/css/cadastro.css" rel="stylesheet">
...
<body class="container-fluid">
        ...
        <div class="col-xl-7 form-container">
            <div class="form-wrapper">
                ...
                <form id="formLogin" method="POST">
                    ...
                    <input type="text" id="nome" name="user" class="form-control" placeholder="Nome de Usuário">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="password" name="password" class="form-control" placeholder="Confirmar Senha">
                        </div>
                    </div>

                    <button name="login" id="login" class="btn">Cadastrar-se</button>
                </form>

                <a href="http://localhost/TCC/login/login" id="cadastro">Já possui login?</a></p>
            </div>
        </div>
    ...
    <script type="text/javascript" src="../VIEW/js/cadastro.js"></script>
